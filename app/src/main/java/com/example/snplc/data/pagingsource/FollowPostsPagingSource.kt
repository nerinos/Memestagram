...
class FollowPostsPagingSource(
    ...
    override suspend fun load(params: LoadParams<QuerySnapshot>): LoadResult<QuerySnapshot, Post> { // calls when we need to load data
        return try {
            ...
            val lastDocumentSnapshot = curPage!!.documents[curPage!!.size() - 1] // last document of shapshot
